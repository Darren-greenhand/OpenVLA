...
class DinoSigLIPViTBackbone(VisionBackbone):
    def __init__(self, vision_backbone_id: str, image_resize_strategy: str, default_image_size: int = 224) -> None:
        ...
        self.dino_featurizer: VisionTransformer = timm.create_model(
            # self.dino_timm_path_or_url, pretrained=True, num_classes=0, img_size=self.default_image_size,checkpoint_path= '/data/jcy/ckpt/vit_large_patch14_reg4_dinov2.lvd142m/model.safetensors'
            self.dino_timm_path_or_url, pretrained=True, num_classes=0, img_size=self.default_image_size
        )
        self.dino_featurizer.eval()

        self.siglip_featurizer: VisionTransformer = timm.create_model(
            # self.siglip_timm_path_or_url, pretrained=True, num_classes=0, img_size=self.default_image_size,checkpoint_path= '/data/jcy/ckpt/ViT-SO400M-14-SigLIP/open_clip_model.safetensors'
