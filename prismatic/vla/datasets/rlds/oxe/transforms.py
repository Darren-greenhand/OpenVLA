...
def realman_orig_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    """
    Applies to version of Bridge V2 in Open X-Embodiment mixture.
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "bridge": bridge_orig_dataset_transform,
    "realman_orig": realman_orig_dataset_transform,
