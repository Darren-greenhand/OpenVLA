...
#change expected_world_size to 1
...
# 它这个train和SFT的区别在哪？
# = [64 GPU] DINO-SigLIP 224px + JCY =
@dataclass
class Exp_SigLIP_224px_JCY(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-siglip-224px+mx-jcy"
    base_vlm: Union[str, Path] = "prism-siglip-224px+7b"
    data_mix: str = "jcy"
...
class VLARegistry(Enum):
    # JCY
    SIGLIP_224PX_MX_JCY = Exp_SigLIP_224px_JCY
